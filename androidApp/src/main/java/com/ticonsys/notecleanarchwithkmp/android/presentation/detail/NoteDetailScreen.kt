package com.ticonsys.notecleanarchwithkmp.android.presentation.detail
    ...
    Scaffold(
        ...
        Column(
            ...
            TransparentHintTextField(
                ...
                onFocusChanged = {
                    viewModel.onIsNoteTitleFocusChanged(it.isFocused)
                },
                singleLine = true,
            ...
            TransparentHintTextField(
                ...
                onFocusChanged = {
                    viewModel.onIsNoteContentFocusChanged(it.isFocused)
                },
                singleLine = false,
                textStyle = TextStyle(fontSize = 20.sp),
